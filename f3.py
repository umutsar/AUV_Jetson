...
while True:
    if not paused:
        ...
        sag_ratio = ratios[4]  # SAĞA YANAŞ bölgesi (index 4)
        sol_ratio = ratios[3]  # SOLA YANAŞ bölgesi (index 3)
        ...
        if decision == "SAĞA YANAŞ":
            best = 4  # SAĞA YANAŞ bölgesi (index 4)
        elif decision == "SOLA YANAŞ":
            best = 3  # SOLA YANAŞ bölgesi (index 3)
